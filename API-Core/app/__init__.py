...
from app.blueprints.routes import items_bp
...
def create_app():
    ...
    #register bp services
    app.register_blueprint(auth_bp, url_prefix='/api/auth')
    app.register_blueprint(items_bp, url_prefix='/api/admin')
    app.register_blueprint(items_crud_bp, url_prefix='/api/items')
